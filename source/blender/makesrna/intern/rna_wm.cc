...
static const EnumPropertyItem event_mouse_type_items[] = {
    ...
    RNA_ENUM_ITEM_SEPR,
    {TOUCHDOWN, "TOUCH_DOWN", 0, CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Touch Down"), ""},
    {TOUCHMOVE, "TOUCH_MOVE", 0, CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Touch Move"), ""},
    {TOUCHUP, "TOUCH_UP", 0, CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Touch Up"), ""},
    {TOUCHCANCEL, "TOUCH_CANCEL", 0, CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Touch Cancel"), ""},
    RNA_ENUM_ITEM_SEPR,
...
const EnumPropertyItem rna_enum_event_type_items[] = {
    ...
    RNA_ENUM_ITEM_SEPR,
    {TOUCHDOWN, "TOUCH_DOWN", 0, "Touch Down", ""},
    {TOUCHMOVE, "TOUCH_MOVE", 0, "Touch Move", ""},
    {TOUCHUP, "TOUCH_UP", 0, "Touch Up", ""},
    {TOUCHCANCEL, "TOUCH_CANCEL", 0, "Touch Cancel", ""},
    RNA_ENUM_ITEM_SEPR,
